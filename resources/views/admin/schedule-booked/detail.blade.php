                        ...
                        @php
                            ...
                            if($detail->status == 'PENDING')
                            {
                                ...
                                if($detail->payment->name != 'COD')
                                {
                                    ...
                                    {
                                        $action_bayar = '<button class="btn btn-secondary btn--payment-proof ms-1" data-id="'.$detail->id.'" data-paymentproof="'.url($detail->payment_proof).'" data-bs-toggle="modal" data-bs-target="#ModalUploadPaymentProof">Konfirmasi Pembayaran</button>';
                                    }

                                    $action = $action_bayar.'<button class="btn btn-danger btn--reject ms-1" data-id="'.$detail->id.'" data-bs-toggle="modal" data-bs-target="#ModalReject">Tolak</button>';
                                }else{
                                    $action = '<button class="btn btn-success btn--approve ms-1" data-id="'.$detail->id.'" data-bs-toggle="modal" data-bs-target="#ModalApprove">Konfirmasi</button>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="content">
                                <ul class="list-group">
                                    <li class="list-group-item border-top border-secondary d-flex justify-content-between text-dark"><span class="title--subtotal-pay">Total</span><span class="transaction--subtotal-pay">Rp{{ number_format($detail->total,0,',','.') }}</span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="mb-3">
