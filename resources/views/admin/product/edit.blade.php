...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <form action="{{ route('admin.product.update',$detail->id) }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="stock" type="number" class="form-control" placeholder="" value="{{ $detail->stock }}">
                        @error('stock')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
